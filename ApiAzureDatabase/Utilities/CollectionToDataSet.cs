...
namespace ApiAzureDatabase.Utilities
{
    public static class CollectionToDataSet
    {
        public static System.Data.DataSet ConvertToDataSet<T>(this IEnumerable<T> source, string name)
        {
            if (source == null)
